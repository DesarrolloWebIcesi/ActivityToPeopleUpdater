...
/**
 * This class is in charge of loading all application configuration files and provide access they
 * properties (Adapted from Dspace 1.7.2 ConfigurationManager class).
 * 
...
public class ConfigurationManager {
    ...
    /**
     * Load the ActivityInsight configuration properties file. Only does anything if
    ...
    public static synchronized void loadConfig(String configFile)
    {
        ...
        try
        {
             ...
             * 
             * This is selection from a property in activitytopeople.cfg, if the property
             * is absent then nothing will be configured and the application
             * will use the defaults provided by log4j. 
             * 
             * Property format is:
             * 
             * log.init.config = log4j.properties
             * or
             * log.init.config = log4j.xml
             * 
            ...
            {
                /* 
                 * Do nothing if log config not set. Leave it upto log4j to properly init its logging 
