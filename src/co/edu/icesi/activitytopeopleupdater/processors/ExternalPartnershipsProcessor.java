 ...
 */
public class ExternalPartnershipsProcessor extends AbstractProcessor{
    
    private static Logger logger = Logger.getLogger(ExternalPartnershipsProcessor.class);
    ...
    public ExternalPartnershipsProcessor(Professor professor, String entitie) {
    ...
    private M4scoAssocMe processAssociation(M4scoAssocMe association, Element multipleNode) {
        ...
        association.setCcbIdActAsc("TA_07");
