 ...
 */
public class MemberProcesor extends AbstractProcessor {
       
    private static Logger logger = Logger.getLogger(MemberProcesor.class);
    ...
    public MemberProcesor(Professor professor, String entitie) {
    ...
    private M4scoAssocMe processAssociation(M4scoAssocMe association, Element multipleNode) {
        ...
        association.setCcbIdActAsc("TA_01");
