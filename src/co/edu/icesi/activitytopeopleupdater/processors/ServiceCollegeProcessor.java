 ...
 */
public class ServiceCollegeProcessor extends AbstractProcessor{
    
    private static Logger logger = Logger.getLogger(ServiceCollegeProcessor.class);
     ...
     */
    public ServiceCollegeProcessor(Professor professor, String entitie) {
    ...
    private M4scoAssocMe processAssociation(M4scoAssocMe association, Element multipleNode) {
        ...
        association.setCcbIdActAsc("TA_03");
