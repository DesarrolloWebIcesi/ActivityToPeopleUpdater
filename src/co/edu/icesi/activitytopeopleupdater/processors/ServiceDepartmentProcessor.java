 ...
 */
public class ServiceDepartmentProcessor extends AbstractProcessor{
    
    private static Logger logger = Logger.getLogger(ServiceDepartmentProcessor.class);
    ...
    public ServiceDepartmentProcessor(Professor professor, String entitie) {
    ...
    private M4scoAssocMe processAssociation(M4scoAssocMe association, Element multipleNode) {
        ...
        association.setCcbIdActAsc("TA_02");
