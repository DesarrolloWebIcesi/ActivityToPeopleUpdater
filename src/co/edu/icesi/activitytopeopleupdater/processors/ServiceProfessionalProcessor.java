 ...
 */
public class ServiceProfessionalProcessor extends AbstractProcessor{
    
    private static Logger logger = Logger.getLogger(ServiceProfessionalProcessor.class);
    ...
    public ServiceProfessionalProcessor(Professor professor, String entitie) {
    ...
    private M4scoAssocMe processAssociation(M4scoAssocMe association, Element multipleNode) {
        ...
        association.setCcbIdActAsc("TA_05");
