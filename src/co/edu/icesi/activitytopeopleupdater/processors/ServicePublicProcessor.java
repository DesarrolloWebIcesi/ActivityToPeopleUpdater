 ...
 */
public class ServicePublicProcessor extends AbstractProcessor{
    
    private static Logger logger = Logger.getLogger(ServicePublicProcessor.class);
     ...
     */
    public ServicePublicProcessor(Professor professor, String entitie) {
    ...
    private M4scoAssocMe processAssociation(M4scoAssocMe association, Element multipleNode) {
        ...
        association.setCcbIdActAsc("TA_06");
