 ...
 */
package co.edu.icesi.activitytopeopleupdater.webservice.connection;

import co.edu.icesi.activitytopeopleupdater.core.ActivityToPeopleUpdater;
...
public class RestConnection {
    ...
    private static org.apache.log4j.Logger logger = Logger.getLogger(RestConnection.class);
    static {
    ...
    public RestConnection(String baseUrl, String[][] pathParams, String[][] params) {
        try {
            ...
            logger.error("Error creating REST Connection", ex);            
        }
    }
            ...
            for (int i = 0; i < params.length; i++) {
                ...
                if (value != null) {
                    try {
                        ...
                        logger.error("Error encodig params", ex);                               
                    }
                }
            }
            if (p.length() > 0) {
